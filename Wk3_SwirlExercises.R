...
# 
# * and tokens:
# -- swirl Week1/Lesson 1 (swirl# 6)  : T Confidence Intervals : qVhchoHNWdJiZ9jA
# -- swirl Week1/Lesson 2 (swirl# 7)  : Hypothesis Testing     : PrZHfhCW12WRfSBi
# -- swirl Week1/Lesson 3 (swirl# 8)  : P Values               : jqRpE80Sb4aIAEps
...
##  -2 + qt(.975,8)*s/sqrt(9) = 0
##  qt(.975,8)*s/sqrt(9) = 2
##  s = 2*sqrt(9)/qt(.975,8)
2*sqrt(9)/qt(.975,8)

##-------------------------------
sp <- sqrt((9*0.60 + 9*0.68)/(9 + 9))
sp
3 - 5 + c(-1,1)*qt(0.975, 9+9)*sp*sqrt(1/10 + 1/10)

##-------------------------------
sp <- sqrt( (99*0.50^2 + 99*2^2)/(99 + 99) )
sp
6 - 4 + c(-1,1)*qnorm(0.975)*sp*sqrt(1/100 + 1/100)

##-------------------------------
sp <- sqrt( (8*1.5^2 + 8*1.8^2)/(8 + 8) )
sp
-3 - 1 + c(-1,1)*qt(.95, 8+8)*sp*sqrt(1/9 + 1/9)
