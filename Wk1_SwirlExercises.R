...
# 
# * and tokens:
# -- swirl Week1/Lesson 1 (swirl# 1)  : Introduction            :  ZkRjgATD2s1mvI5M
# -- swirl Week1/Lesson 2 (swirl# 2)  : Probability1            :  wiYPJB3k9dSnSeJY
# -- swirl Week1/Lesson 3 (swirl# 3)  : Probability2            :  oZYOdmvyI9ckDvuI
# -- swirl Week1/Lesson 4 (swirl# 4)  : ConditionalProbability  :  rUUwHUVhzf9RbzrB
# -- swirl Week1/Lesson 5 (swirl# 5)  : Expectations            :  JUUMFm09PkqIqnmO
...
## Then, follow the menus and select the Statistical Inference course when given 
# the option. For 
## the first part of this course you should complete the following lessons:
##     - Introduction
##     - Probability1
##     - Probability2
